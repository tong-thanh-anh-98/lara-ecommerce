            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/products') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="quantity" class="form-control" row="4"/>
                                    </div>
                                </div>                           
                                <div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        <div class="tab-pane fade border p-3" id="color-tab-pane" role="color" aria-labelledby="color-tab" tabindex="0">
                            <div class="mb-3">
