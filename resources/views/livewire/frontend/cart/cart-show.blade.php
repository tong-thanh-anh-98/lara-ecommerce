        ...
        <div class="container">
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">{{ $cartItem->product->selling_price }} VNĐ</label>
                                    </div>
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">{{ $cartItem->product->selling_price * $cartItem->quantity }} VNĐ</label>
                                        @php
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        Get the deals & Offers <a href="{{ url('/collections') }}">Shop now</a>
                    </h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total:
                            <span class="fload-end">
                                {{ $totalPrice }} VNĐ
                            </span>
                        </h4>
                        <hr>
